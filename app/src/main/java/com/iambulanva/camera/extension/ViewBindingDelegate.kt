...
class ViewBindingDelegate<B: ViewBinding>(private val fragment: Fragment, private val viewBindingClass: Class<B>) {
    ...
    operator fun getValue(thisRef: Any?, property:KProperty<*>):B{
        ...
        if (viewLifecycleOwner.lifecycle.currentState == Lifecycle.State.DESTROYED){
            ...
            return getOrCreatedBinding(viewLifecycleOwner)
        } else {
    ...
    private fun getOrCreatedBinding(viewLifecycleOwner: LifecycleOwner):B {
